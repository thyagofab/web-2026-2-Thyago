              ...
              {suplentes.map((sup) => (
                ...
                >
                  <div>
                    ...
                    <span className="text-[10px] font-semibold text-amber-800 bg-amber-50 px-2 py-0.5 rounded block w-max mt-1">
                  ...
                  <div className="shrink-0">
                    {camasLivres.length > 0 ? (
                      <button
                        ...
                        className="px-3 py-1.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg font-bold text-xs flex items-center gap-1 shadow-2xs"
                      >
          ...
          <div>
            ...
            <div className="space-y-3">
              {camasLivres.map((item, idx) => (
                <div
                  key={idx}
                  className="p-3.5 rounded-xl border border-emerald-200 bg-emerald-50/40 flex items-center justify-between gap-3 text-xs"
                >
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-emerald-800 hover:bg-emerald-900 text-white rounded-lg font-bold text-xs flex items-center gap-1 shadow-2xs"
                  >
                    <UserPlus className="w-3.5 h-3.5" />
                    Alocar Convocado
                  </button>
            ...
            {aguardandoPosse.map((aluno) => (
              ...
              >
                <div>
                  ...
                  <span className="text-sky-800 font-semibold block text-[11px] mt-0.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg font-bold flex items-center gap-1 shadow-2xs"
                  >
                ...
                .map((morador) => (
                  <tr key={morador.id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="px-3 py-3">
                      ...
                      <span className="text-slate-500 text-[11px] block">{morador.campusNome}</span>
                    </td>
